    ...
    create_custom_fields(
        {
            ...
            "Sales Order": [
                ...
                },
                {
                    ...
                    "collapsible": 1,
                    "collapsed": 1,
                    "description": "Read-only stock by allowed warehouse for items in this Sales Order company. Qty: on hand. Available After SO: on hand minus open confirmed Sales Order demand. Projected Available: Available After SO plus expected incoming Purchase Order quantity.",
                },
                {
                ...
                },
                {
                    ...
                    "label": "Shared Company Stock",
                    "fieldtype": "Section Break",
                    "insert_after": "custom_warehouse_stock_snapshot",
                    "collapsible": 1,
                    "collapsed": 1,
                    "description": "Read-only stock in the companies this document's selling price list is shared with. Qty: on hand. Available After SO: on hand minus open confirmed Sales Order demand. Projected Available: Available After SO plus expected incoming Purchase Order quantity.",
                },
                {
                    ...
                    "insert_after": "custom_shared_company_stock_section",
                    "read_only": 1,
                },
            ],
            "Quotation Item": [
    ...
    create_custom_fields(
        {
            ...
            "Pricing Sheet": [
                ...
                },
                {
                    ...
                    "collapsible": 1,
                    "collapsed": 1,
                    "description": "Read-only stock by allowed warehouse for items in this Pricing Sheet company. Qty: on hand. Available After SO: on hand minus open confirmed Sales Order demand. Projected Available: Available After SO plus expected incoming Purchase Order quantity.",
                },
                {
                    "fieldname": "custom_warehouse_stock_snapshot",
                    "label": "Stock by Warehouse",
            ...
            "Quotation": [
                {
                    ...
                    "collapsible": 1,
                    "collapsed": 1,
                    "description": "Read-only stock by allowed warehouse for items in this Quotation company. Qty: on hand. Available After SO: on hand minus open confirmed Sales Order demand. Projected Available: Available After SO plus expected incoming Purchase Order quantity.",
                },
                {
                    "fieldname": "custom_warehouse_stock_snapshot",
                    "label": "Stock by Warehouse",
            ...
            "Quotation Item": [
                ...
                },
                {
                    ...
                    "fieldtype": "Float",
                    "insert_after": "custom_available_after_so_qty",
                    "read_only": 1,
                    "in_list_view": 1,
            ...
            "Purchase Order": [
                ...
                },
                {
                    ...
                    "collapsible": 1,
                    "collapsed": 1,
                    "description": "Live read-only stock for items in this Purchase Order company. Qty: on hand. Available After SO: on hand minus open confirmed Sales Order demand. Projected Available: Available After SO plus expected incoming Purchase Order quantity.",
                },
                {
                    "fieldname": "custom_warehouse_stock_snapshot",
                    "label": "Stock by Warehouse",
                ...
                },
                {
                    ...
                    "collapsible": 1,
                    "collapsed": 1,
                    "description": "Live read-only stock in the internal supplier company or in the company that shared the buying price list into this company.",
                },
                {
                    "fieldname": "custom_shared_company_stock",
                    "label": "Supplier Company Stock",
            ...
            "Purchase Order Item": [
                {
                    ...
                    "read_only": 1,
                    "in_list_view": 1,
                    "description": "Live total stock in the document company warehouses.",
                },
                {
                    "fieldname": "custom_available_after_so_qty",
                    "label": "Available After SO",
                    ...
                    "read_only": 1,
                    "in_list_view": 1,
                    "description": "On hand minus open confirmed Sales Order demand: what physically remains.",
                },
                {
                    "fieldname": "custom_projected_available_qty",
                    "label": "Projected Available",
                    ...
                    "read_only": 1,
                    "in_list_view": 1,
                    "description": "Available After SO plus expected incoming Purchase Order quantity.",
                },
                {
                    "fieldname": "custom_source_buying_price_list",
