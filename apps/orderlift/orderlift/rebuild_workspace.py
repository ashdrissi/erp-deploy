...
def execute():
    ...
    ws.append('items', {'type': 'Link', 'label': 'Pricing Sheets', 'link_type': 'DocType', 'link_to': 'Pricing Sheet', 'child': 1})
    ws.append('items', {'type': 'Link', 'label': 'Pricing Scenarios', 'link_type': 'DocType', 'link_to': 'Pricing Scenario', 'child': 1})
    ws.append('items', {'type': 'Link', 'label': 'Market Prices', 'link_type': 'DocType', 'link_to': 'Market Price Entry', 'child': 1})

    ws.append('items', {'type': 'Section Break', 'label': 'Policies & Configs', 'child': 0})
    ws.append('items', {'type': 'Link', 'label': 'Agent Rules', 'link_type': 'DocType', 'link_to': 'Agent Pricing Rules', 'child': 1})
    ws.append('items', {'type': 'Link', 'label': 'Segmentation Engine', 'link_type': 'DocType', 'link_to': 'Customer Segmentation Engine', 'child': 1})
    ws.append('items', {'type': 'Link', 'label': 'Benchmark Policy', 'link_type': 'DocType', 'link_to': 'Pricing Benchmark Policy', 'child': 1})
    ws.append('items', {'type': 'Link', 'label': 'Customs Policy', 'link_type': 'DocType', 'link_to': 'Pricing Customs Policy', 'child': 1})
    ws.append('items', {'type': 'Link', 'label': 'Margin Policy', 'link_type': 'DocType', 'link_to': 'Pricing Margin Policy', 'child': 1})
    ws.append('items', {'type': 'Link', 'label': 'Scenario Policy', 'link_type': 'DocType', 'link_to': 'Pricing Scenario Policy', 'child': 1})
