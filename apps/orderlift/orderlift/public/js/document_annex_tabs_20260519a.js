(function () {
    ...
    function injectStyles() {
        ...
        `;
        style.textContent += `
            .ol-annex-frappe-tab{min-height:0;overflow:visible;}
            .ol-annex-host{min-height:0;max-width:100%;}
            .ol-annex-shell{max-height:calc(100vh - 190px);display:flex;flex-direction:column;min-height:0;}
            .ol-annex-panels{min-height:0;overflow:auto;overscroll-behavior:contain;}
