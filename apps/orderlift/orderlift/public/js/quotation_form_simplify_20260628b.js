(function () {
    ...
    frappe.ui.form.on("Quotation", {
        ...
        onload_post_render(frm) {
            ...
            showTaxFields(frm);
            applyQuotationItemPricingLayout(frm);
            // Run once on form open only. refresh fires after every save and
            // these async recalcs rewrite the child table / item fields and
            // re-dirty the form, causing the "turns back to Draft / Save does
            // nothing" loop. The old __unsaved guard was unreliable post-save.
