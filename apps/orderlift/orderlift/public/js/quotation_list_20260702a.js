(function () {
    ...
    function useQuotationIdAsSubject(listview) {
        if (!listview || !listview.doctype || listview.doctype !== "Quotation") return;
    ...
    function applyQuotationListStyles(listview) {
        ...
        $("head").append(`
            <style id="orderlift-quotation-list-style">
                .orderlift-quotation-list .list-row-head .list-header-subject,
                .orderlift-quotation-list .list-row-container .list-subject {
                    flex: 0 0 220px;
                    max-width: 220px;
                }
    ...
    function patchQuotationColumnSetup(listview) {
        if (!listview || listview.__orderlift_quotation_columns_patched) return;
