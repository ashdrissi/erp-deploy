...
<div class="pbp-help-panel pbp-help-sources">
    ...
    <div class="pbp-help-body">
        ...
        <p>${__("Each source is a <strong>Selling Price List</strong> representing a competitor or market reference. The engine fetches the price for each item from every active source, then combines them using the chosen method (Median / Average / Weighted Average).")}</p>
        <ul>
