(function orderliftHomePageScrollFix() {
    if (window.__orderlift_home_page_scroll_fix_20260520b_installed) return;
    window.__orderlift_home_page_scroll_fix_20260520b_installed = true;

    var STYLE_ID = "orderlift-home-page-scroll-fix-20260520b";
